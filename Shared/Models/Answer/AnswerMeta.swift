...
//
//   let answerMeta = try AnswerMeta(json)
//
// To read values from URLs:
//
//   let task = URLSession.shared.answerMetaTask(with: url) { answerMeta, response, error in
//     if let answerMeta = answerMeta {
//       ...
//     }
//   }
//   task.resume()
...
// MARK: AnswerMeta convenience initializers and mutators

extension AnswerMeta {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(AnswerMeta.self, from: data)
    }
